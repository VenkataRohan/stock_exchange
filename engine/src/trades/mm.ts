...
export const mm = (engine: Engine) => {
    setInterval(() => {
        createCloseBids(engine);
        createCloseAsks(engine);
    }, 1000)

    setInterval(() => {
        createFarAsks(engine);
        createFarBids(engine);
    }, 3000)

    setInterval(() => {
        createRandomBidOrAsk(engine)
    }, 10000)
}


const createCloseBids = (engine: Engine) => {
    stocks.forEach((e) => {
...
const createFarBids = (engine: Engine) => {
    stocks.forEach((e) => {
...
const createCloseAsks = (engine: Engine) => {
    stocks.forEach((e) => {
...
const createFarAsks = (engine: Engine) => {
    stocks.forEach((e) => {
...
const createRandomBidOrAsk = (engine: Engine) => {
    stocks.forEach((e) => {
